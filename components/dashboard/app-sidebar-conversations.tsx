...
import { Bell, ChevronDown, Loader2, MoreHorizontal, PencilIcon, TrashIcon } from "lucide-react"
...
export const AppSidebarConversations = () => {
  ...
  }, [pathname, setActiveId]) // Removed unnecessary dependencies: conversations, refreshConversations
