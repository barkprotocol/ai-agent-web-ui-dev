        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    frequency: e.target.value ? Number.parseInt(e.target.value, 10) : null, // Parse or null
                  }))
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    maxExecutions: e.target.value ? Number.parseInt(e.target.value, 10) : null, // Parse or null
                  }))
                }
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button onClick={handleEdit} disabled={isLoading || !formData.description.trim()}>
...
export const AppSidebarAutomations = () => {
  ...
  }, [refreshActions, handleActionMutation]) // Added handleActionMutation to dependencies
        ...
        <CollapsibleContent className="data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
          <SidebarGroupContent className="group-data-[collapsible=icon]:hidden">
            {isActionsLoading ? (
              ...
              <SidebarMenu>
                {actions.map((action) => (
                  <ActionMenuItem key={action.id} action={action} onDelete={handleDelete} onEdit={handleEdit} />
                ))}
              </SidebarMenu>
            )}
          </SidebarGroupContent>
